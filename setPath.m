...
function setPath(setNewPathFlag)
  ...
  if setNewPathFlag
    ...
    addpath(folder);
    addpath(genpath(fullfile(folder, 'Classes')));
    addpath(genpath(fullfile(folder, 'GUI')));
    addpath(genpath(fullfile(folder, 'ThirdPartyDependencies')));
    addpath(genpath(fullfile(folder, 'Utilities')));
