...
%==========================================================================
    function Setup()
        ...
        mZoomMaxPow = 10;            % max zoom perzent 10 ^ mZoomMaxPow
        mZoomNum = 101;              % count steps of log zoom grid
        ...
        % Rubber Band Options
        mRbEdgeColor = [1 0 0];         % rubber band edge color
        mRbFaceColor = [0 0 0];      % rubber band face color
        mRbFaceAlpha = 0.10;           % rubber band face alpha (transparency)
...
%         set(hFig, 'Name', newName) % disabled window name change
    end
%--------------------------------------------------------------------------
