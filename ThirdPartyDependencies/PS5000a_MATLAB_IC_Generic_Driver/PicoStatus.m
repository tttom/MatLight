...
%
% Description:
%   This is a MATLAB class definition that defines the Pico Status values.
%
%	MATLAB does not directly handle hexadecimal values so these are 
